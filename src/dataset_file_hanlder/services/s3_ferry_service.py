...
class S3Ferry:
    ...
    def transfer_file(self, destination_file_path: str, destination_storage_type: str, 
                     source_file_path: str, source_storage_type: str) -> requests.Response:
        """
        ...
        try:
            ...
            logger.info(f"[S3_FERRY] Transferring file: {source_file_path} -> {destination_file_path}")
            ...
            if response.status_code not in [200, 201]:
                ...
                logger.info(f"[S3_FERRY] ✅ Transfer successful (HTTP {response.status_code})")
    ...
    def get_s3_ferry_payload(self, destination_file_path: str, destination_storage_type: str, 
                           source_file_path: str, source_storage_type: str) -> Dict[str, str]:
        """
    ...
    def upload_to_s3(self, local_file_path: str, s3_destination_path: str) -> requests.Response:
        """
    ...
    def download_from_s3(self, s3_source_path: str, local_destination_path: str) -> requests.Response:
        """
