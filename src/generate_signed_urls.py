...
def upsert_agency_to_database(agency_id: str, agency_name: str, data_url: str) -> bool:
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            update_url = "http://resql:8082/global-classifier/update-agency-presigned-url"
            ...
            if update_response.status_code == 200:
                ...
                print(f"Failed to update agency {agency_id}: HTTP {update_response.status_code}")
...
def main():
    ...
    if len(sys.argv) < 2:
        ...
        print('Expected format: URL-encoded JSON array with agencyId and agencyName fields')
        sys.exit(1)
    ...
    for file_info in files_to_process:
        try:
            ...
            successful_agencies.append({
                ...
                "agency_name": file_info["key"].split("/")[0],  # Extract agency name from key
                "data_url": url
            })
        except Exception as e:
    ...
    if successful_agencies:
        ...
        print(f"Successfully stored {db_success_count}/{len(successful_agencies)} agencies in database")
