...
import { getDataGenerationProgress } from 'services/datasets';
import sse from 'services/sse-service';
import { SSEEventData, ValidationProgressData } from 'types/datasets';
import { datasetQueryKeys } from 'utils/queryKeys';

export const useDataGenerationSessions = () => {
        ...
        (progress) =>
          !(
            progress.generationStatus ===
              DataGenerationSessionsStatuses.VALIDATION_SUCCESS_STATUS ||
            progress.generationStatus ===
              DataGenerationSessionsStatuses.VALIDATION_FAILED_STATUS
